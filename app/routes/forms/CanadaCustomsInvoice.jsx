...
export const action = async ({request}) => {
    ...
    const shipperPhone = data.get("shipperPhone")
    const shipperAddress = data.get("shipperAddress")

    const fields = { shipperName, shipperContact, shipperPhone, shipperAddress}
